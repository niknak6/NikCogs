...
class PinExtender(commands.Cog):
    ...
    async def on_guild_channel_pins_update(self, channel, last_pin_message):
        ...
        if isinstance(channel, discord.TextChannel):
            ...
            if extended_pins_message_id is not None:
                ...
                if len(pinned_messages) > 49:
                    ...
                    new_pin_message = last_pin_message or await channel.fetch_message(channel.last_message_id)
