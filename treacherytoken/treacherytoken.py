...
class TreacheryToken(commands.Cog):
    ...
    async def wowtoken(self, ctx):
        ...
        embed.add_field(value="\u200b", inline=True) # This is a blank field that acts as a spacer
        embed.add_field(name="Daily Range", value=f"{data['us']['1_day_low']:,} - {data['us']['1_day_high']:,} gold", inline=True)
        embed.add_field(value="\u200b", inline=True) # This is another blank field that acts as a spacer
