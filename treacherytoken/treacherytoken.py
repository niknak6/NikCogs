...
class TreacheryToken(commands.Cog):
    ...
    async def wowtoken(self, ctx):
        ...
        embed.add_field(name="Last Updated (*This is your local time*)", value=timestamp) # This is the change I made to move the dynamic timestamp from the embed footer to another field in the embed
